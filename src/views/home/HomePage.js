...
const HomePage = () => {
  ...
  return (
    <div className="body-with-bg">
      {/* Navbar aquí si quieres incluirla */}

      <main className="container text-center my-5">
        <h1 className="mb-3">Publica un Pololo.<br />Genera Ingresos Con Trabajos Pequeños.</h1>
        <p className="lead mb-4">
          Conectamos a personas que buscan ayuda con servicios locales dispuestos a brindar soluciones
        </p>
        <a href="/servicios" className="btn btn-primary btn-lg w-auto">Buscar Servicios</a>

        {/* Video Tutorial */}
        <div className="video-tutorial my-5">
          <h2 className="mb-3">¿No sabes cómo usar Pololitos?</h2>
          <p className="mb-4">
            Mira este video corto donde te explicamos paso a paso cómo buscar, publicar y contactar por un pololito.
          </p>
        ...
        <div className="row justify-content-center my-5">
          <div className="col-md-10 bg-dark text-white rounded p-4 d-flex flex-wrap align-items-center">
            <img src="/img/work.jpg" alt="Publicidad" className="img-fluid rounded me-4" style={{ maxWidth: "250px" }} />
            <div>
              ...
              <a href="/contacto" className="btn btn-warning">Solicitar Publicidad</a>
            </div>
          </div>
        </div>
        ...
        <div className="section mb-5">
          <h2 className="text-center mb-4">Nuevos servicios que podrían interesarte</h2>
          <div className="carousel-container">
            <button className="carousel-btn prev" onClick={moverIzquierda}>&#10094;</button>
            ...
            <button className="carousel-btn next" onClick={moverDerecha}>&#10095;</button>
          </div>
        </div>
      </main>
